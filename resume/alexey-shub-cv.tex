...
% Small contribution to open sourse:
% * xonsh
% * lark
%
% I want to learn something from:
% * Mathematical statistics (for data science for example)
% * Formal verification of software
% * DSL creation (grammars)
% * Pure functioanal programming and related math theories (Category theory, Haskell, dependent types)

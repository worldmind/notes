...
\begin{europasscv}
  ...
  \ecvitem{}{Different server side things. New features and refactoring spaghetti code, for example of auth system for creating readable, maintainable and security auth
    system.}

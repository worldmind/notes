...
\begin{europasscv}
  ...
  \ecvtitle{Jun 2017 – Jun 2017}{Software Developer}
  \ecvitem{}{Small Django web service. Python, Django, Linux.}

  \ecvtitle{Jan 2017 – Jan 2017}{Software Developer}
  \ecvitem{}{Small REST service.}
  \ecvitem{}{Python, Swagger, Linux.}
  
  \ecvtitle{Jan 2016 – Oct 2016}{Software Developer}
  \ecvitem{}{AppFollow. Remote job}
  \ecvitem{}{Different server side things. New features and refactoring spaghetti code, for example of auth system to readable, maintainable and security auth
    system.}
  ...
  \ecvitem{}{PerI, PostgreSQL, Redis, Linux}
  ...
  \ecvitem{}{``Press Any Key'' Master (universal IT soldier) - solve software, hardware and human problems. Write some scripts for automation.}
  ...
  \ecvitem{Communication skills}{
    \begin{ecvitemize}
      \item Team work: always from 2007 successfully work in teams, average 10 members.
      \item Mediating skills: Successfully help fin a compromise in technical discussions.
    \end{ecvitemize}
  }
  ...
  \ecvitem{}{Talk about architectural problems of web client side technology stack/}

  \ecvitem{Sep 2012}{Lector. Gomel'ski Dzjaržauny Universitet}
  \ecvitem{}{Two lections (Russian):
    \begin{ecvitemize}
      \item about software development (https://github.com/worldmind/typical-dev-tasks-presentation-ru);
      \item about software developing managment (https://github.com/worldmind/software-dev-process-presentation-ru).
    \end{ecvitemize}
  }

  \ecvitem{Apr 2011}{Speaker. RITConf}
  \ecvitem{}{Talk about unit testing}

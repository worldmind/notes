...
\begin{europasscv}
  ...
  \ecvitem{}{Different server side things (MVC/Queue, parsing via Selenium, Docker).
    Refactoring spaghetti code, for example of auth system to readable, maintainable and security auth
    system.}
  ...
  \ecvitem{Communication skills}{
    \begin{ecvitemize}
      \item team work:
      \item mediating skills:
    \end{ecvitemize}
  }

  \ecvitem{Job related skills}{itemlist}
  % add skills to jobs record
